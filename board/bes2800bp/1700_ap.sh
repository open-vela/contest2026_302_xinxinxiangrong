...
INIT_SCRIPT_FILES=(
    "vendor/bes/boards/best1700_ep/aos_evb/src/etc/init.d/rc.sysinit.ap"
    "vendor/bes/boards/best1700_ep/aos_evb/src/etc/init.d/rcS"
    "vendor/bes/boards/best1700_ep/aos_evb/src/etc/init.d/rcS.ap"
)
CONFIG_STAMP_FILE="$LEGACY_BUILD_DIR/.ap_build_inputs.sha256"

current_build_inputs_hash=$(
    sha256sum "$0" "$DEFCONFIG_FILE" "${INIT_SCRIPT_FILES[@]}" \
